...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body id="body">
      ...
      <nav>
        ...
        <ul class="right">
          <li><a class="pditalic" href="/">Startseite</a></li>
        </ul>
      ...
      <section id="header" class="article">
  	     ...
  	     <p class="focus-in-expand">HALLO WELT ICH BIN ZWAR IMMER NOCH <span class="underline--magical">QASIM RAZA<span></p>
           <p>404! Aber diese Seite existiert nicht bzw. nicht mehr</p>
